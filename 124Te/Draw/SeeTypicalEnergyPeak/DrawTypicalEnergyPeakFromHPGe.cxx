...
void DrawTypicalEnergyPeakFromHPGe(){



   TH1D * h11 = new TH1D("h11","h11",100,0,25);

   TFile *_file0 = TFile::Open("TEST0.root");
   TTree * Tree0 = (TTree*)_file0->FindObjectAny("EGammaSpectrumInHPGeactiveCrystal;1");
   ...
   {
      Tree0->GetEntry(i);
      h11->Fill(EGammaSpectrumInHPGeactiveCrystal);
   }	   
